...
| o2-tof-reco-workflow --input-type raw --output-type clusters ${ARGS_ALL} ${CTF_DICT} ${GRP_PATH} --disable-root-output --calib-cluster --cluster-time-window 5000 --cosmics \
